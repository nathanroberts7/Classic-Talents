...
struct TalentTree: Codable {
    let id: Int
    let name: String
    let skillPoints, currentSkillTier: Int
...
struct Requirements: Codable {
    let specPoints: Int?
    let skill: RequirementsSkill?
}

// MARK: - RequirementsSkill
struct RequirementsSkill: Codable {
    let id, skillPoints: Int
}
